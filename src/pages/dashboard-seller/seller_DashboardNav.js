...
const SellerDashboardNav = ({  }) => {
  ...
  const navigationItems = [
    ...
    { label: 'Profile', icon: <AccountCircleIcon />, link: '/seller-profilepage' },
    { label: 'Dashboard', icon: <HomeIcon />, link: '/seller-dashboard' },
    { label: 'Early Payment', icon: <FastForwardIcon />, link: '/seller-earlypayment' },
    { label: 'Tokens', icon: <TokenIcon />, link: '/seller-tokens' },
    { label: 'Approved PDFs', icon: <DescriptionOutlinedIcon />, link: '/seller-ApprovedPDFs' },
    { label: 'Invoice', icon: <ReceiptIcon />, link: '/seller-invoice' },
    // { label: 'Invoices For Approval', icon: <ReceiptIcon />, link: '/seller-InvoicesForApproval' },
    { label: 'Pending Approvals', icon: <ReceiptIcon />, link: '/seller-pendingapproval' },
    { label: 'Settings', icon: <SettingsIcon />, link: '/seller-settings' },
    { label: 'Support', icon: <HelpIcon />, link: '/seller-support' },
  ];
